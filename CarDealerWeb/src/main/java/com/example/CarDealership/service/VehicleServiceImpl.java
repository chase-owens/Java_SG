...
public class VehicleServiceImpl implements VehicleService {
    ...
    @Autowired
    public VehicleServiceImpl(VehicleDao vehicleDao, MakeService makeService, ModelService modelService, UserService userService) {
    ...
    @Override
    public Vehicle createVehicle(int makeId, int modelId, int mileage, int year, String vehicleType, String vehicleDescription, String image, String exteriorColor, String interiorColor, String transmission, String bodyStyle, String vin, String msrpString, String listPriceString, int userId) throws TooManyMilesToBeNewError, DataValidationError {
        BigDecimal msrp, listPrice;
        Make make;
        Model model;
        if (vehicleType.equals("") || bodyStyle.equals("") || exteriorColor.equals("") || interiorColor.equals("") || vehicleDescription.equals("") || image.equals("") || vin.equals("")) {
        ...
        if (vin.length() != 17 || vin.contains("O") || vin.contains("I") || vin.contains("Q") || vin.contains("o") || vin.contains("i") || vin.contains("q")) {
            throw new DataValidationError();
        }
        ...
        try {
            ...
            if (listPrice.compareTo(BigDecimal.ZERO) < 1 || msrp.compareTo(BigDecimal.ZERO) < 1 || listPrice.compareTo(msrp) == 1) {
                throw new DataValidationError();
            }
    ...
    @Override
    public void updateVehicle(int vehicleId, int makeId, int modelId, int mileage, int vehicleYear, String vehicleType, String vehicleDescription, String image, String exteriorColor, String interiorColor, String transmission, String bodyStyle, String vin, String msrpString, String listPriceString, String isFeatured, int userId) throws TooManyMilesToBeNewError, DataValidationError {
        BigDecimal msrp, listPrice;
        Vehicle vehicle;

        if (vehicleType.equals("") || bodyStyle.equals("") || exteriorColor.equals("") || interiorColor.equals("") || vehicleDescription.equals("") || vin.equals("")) {
            throw new DataValidationError();
        }
