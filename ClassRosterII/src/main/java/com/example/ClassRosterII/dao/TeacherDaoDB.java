...
public class TeacherDaoDB implements TeacherDao {
    ...
    public List<Teacher> getAllTeachers() {
        final String GET_TEACHERS = "SELECT * FROM teacher";
        return jdbc.query(GET_TEACHERS, new TeacherMapper());
    }

    @Override
    @Transactional
    public Teacher addTeacher(Teacher teacher) {
        final String ADD_TEACHER = "INSERT INTO teacher(firstName, lastName, specialty) VALUES(?,?,?)";
        jdbc.update(ADD_TEACHER, teacher.getFirstName(), teacher.getLastName(), teacher.getSpecialty());
