...
public class PassingTheTuringTest {
    public static void main(String[] args) {
        ...
        System.out
                .println(favoriteFood + " sounds really good! I could take a " + myFavoriteFood + " out of anything!!");

        System.out.println("Tell me your favorite number. ");
        favoriteNumber = inputReader.nextDouble();
        sum = favoriteNumber + myFavoriteNumber;
        System.out.println(favoriteNumber + " is a cool number! My favorite number is " + myFavoriteNumber + ". "
                + favoriteNumber + " + " + myFavoriteNumber + " is " + sum
                + "! That's a cool number too!! What a combination we make!");
